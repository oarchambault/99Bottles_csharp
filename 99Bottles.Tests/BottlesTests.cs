...
public class BottlesTests
{
    ...
    public void The_first_verse()
    {
        ...
        var verse = new Bottles().Verse(99);
    ...
    public void Verse_0()
    {
        ...
        var verse = new Bottles().Verse(0);
        verse.Should().Be(expected);
    }

    [Fact]
    public void A_couple_verses()
    {
        var expected = "99 bottles of beer on the wall, " +
                       "99 bottles of beer.\n" +
                       "Take one down and pass it around, " +
        ...
        var verses = new Bottles().Verses(99, 98);
        verses.Should().Be(expected);
    }
    ...
    public void A_few_verses()
    {
        var expected = "2 bottles of beer on the wall, " +
                       ...
                       "Go to the store and buy some more, " +
                       "99 bottles of beer on the wall.\n";
        var verses = new Bottles().Verses(2, 0);
        verses.Should().Be(expected);
    }

    [Fact]
    public void The_whole_song()
    {
